...
SOURCES = [
    ...
    StockSource("AAPL", 3, DATA_DIR / "aapl_style_hour_message_clean.csv"),
]

OUT_CSV = DATA_DIR / "three_stock_style_hour_message_clean_merged.csv"
OUT_META = DATA_DIR / "three_stock_style_hour_message_clean_merged_metadata.txt"
...
def write_metadata(rows_written: int):
    ...
    with OUT_META.open("w", newline="") as handle:
        handle.write("Merged three-stock clean hour replay\n")
