...
module tb_hft_single_stock_top_lobster;
    ...
    localparam string LOBSTER_MESSAGE_CSV =
        "ITCH_Translator/LOBSTER_SampleFile_AMZN_2012-06-21_1/three_stock_style_hour_message_clean_merged.csv";
    ...
    initial begin
        ...
        $display("=== HFT Three-Stock LOBSTER Replay ===");
        $display("Streaming merged three-stock file: %s", LOBSTER_MESSAGE_CSV);
