...
module parser_avalon_wrapper #(
    ...
    parameter int BOOK_BASE_PRICE    = 32'd5_820_000,
    ...
    parameter logic [SYMBOL_LEN-1:0] DEFAULT_SYMBOL = {"A","A","P","L"," "," "," "," "},
    ...
    function automatic [31:0] base_price_for_stock(
        ...
        begin
            case (stock_id_in)
                STOCK_LEN'(1): base_price_for_stock = AAPL_BOOK_BASE_PRICE;
                STOCK_LEN'(2): base_price_for_stock = AMZN_BOOK_BASE_PRICE;
                STOCK_LEN'(3): base_price_for_stock = INTC_BOOK_BASE_PRICE;
                STOCK_LEN'(4): base_price_for_stock = MSFT_BOOK_BASE_PRICE;
