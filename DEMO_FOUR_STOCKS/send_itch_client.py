...
DEFAULT_PORT     = 7000
DEFAULT_CSV      = Path(__file__).parent / "ITCH_Translator" / "LOBSTER_SampleFile_AMZN_2012-06-21_1" / "four_stock_style_hour_message_clean_merged.csv"
...
def main():
    ...
    p.add_argument("--ticker", default="AAPL", help="Fallback stock ticker symbol for legacy rows/payloads (default: AAPL)")
