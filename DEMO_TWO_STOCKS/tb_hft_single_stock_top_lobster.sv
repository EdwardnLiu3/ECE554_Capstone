...
module tb_hft_single_stock_top_lobster;
    ...
    localparam string LOBSTER_MESSAGE_CSV =
        "ITCH_Translator/LOBSTER_SampleFile_AMZN_2012-06-21_1/two_stock_style_hour_message_clean_merged.csv";
    ...
    initial begin
        ...
        $display("=== HFT Two-Stock LOBSTER Replay ===");
        $display("Streaming entire merged two-stock file: %s", LOBSTER_MESSAGE_CSV);
