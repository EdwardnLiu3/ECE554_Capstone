...
localparam int PRICE_TICK = (PRICE_LEN <= 16) ? 1 : 100;
...
// FLB update
(* ram_style = "M10K" *) logic [TOT_QUATITY_LEN-1:0]  FLB [0:NUM_LEVELS-1];
logic [TOT_QUATITY_LEN-1:0]                          old_qty3, new_qty4, new_qty5;
...
flb_refill_engine_ask_1024 refill_engine(
    .i_clk(i_clk),
    .i_rst_n(i_rst_n),
...
// OUTPUT
assign o_best_price = BASE_PRICE + (cache[0].index * PRICE_TICK);
